...
### Diagrama de Puntos
[Diagrama ASCII de las vueltas/filas principales usando estos símbolos exactos:
○ = cadena (cad)
× = punto bajo (pb)
T = punto alto (pa)
⊕ = punto deslizado (pp)
Muestra entre 3 y 6 vueltas representativas numeradas. Ejemplo de formato:
Vuelta 1: ○○○○○○○○○○○○
Vuelta 2: ×  ×  ×  ×  ×  ×
Vuelta 3: T  T  T  T  T  T
Referencia: ○=cad  ×=pb  T=pa  ⊕=pp]
